let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `DINKA ANIMATIONS 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 GROUP 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊:* https://chat.whatsapp.com/J5aESP25w7qIwklFpsPZ5X\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `DINKA ANIMATIONS 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/J5aESP25w7qIwklFpsPZ5X \n\n ${Config.botname} *WORKS*`;
 ...
 let tmpUrl = "https://telegra.ph/file/f5e0751267307ac475187.mp4";
 const secmailData = {};
 smd({
   pattern: "tempmail",
